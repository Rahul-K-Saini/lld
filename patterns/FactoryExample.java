...
public class FactoryExample {
    ...
    // factory of that product which decide which product to give based on type parameter using if/else or switch case
    ...
    // this instead of having if else for that responsibility of creating the object this delegates
